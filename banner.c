/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///
/// Linux BunnerプログラムをWindows用に改変
/// 
/// 
/// 
///	
///   履歴	
///   2023/09/20 V1.00 First
///
///
...
///
///  #define _CRT_SECURE_NO_WARNINGS  <-  先頭の方に記述してもOK
/// 
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 *
...
static int add_to_banner(char **banner, int height, int space, char letter, int maxwidth)
{
   ...
   for(i=0; i<height; i++)
   {
      ...
      //strncat(banner[i], working_char[i], sizeof(banner[i]) - strlen(banner[i]) - 1);
